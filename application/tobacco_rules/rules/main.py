...
from application.tobacco_rules.rules.write_hbase import delete_all
...
if day_of_week==0 and hour==3:
        from application.tobacco_rules.rules import update_cust_status,get_cust_info,get_acc,get_city_county,get_lng_lat,get_30_grade_change,card_passId,get_cust_index,\
        ...
        from application.tobacco_rules.rules import get_city,get_trans_busiArea_index,get_gdp_index,get_ppl_areaCpt_index
        ...
        from application.tobacco_rules.rules import get_block_item_top
        print(f"{str(dt.now())} ----------block_data")
        get_block_item_top()


        from application.tobacco_rules.rules import get_city,get_area_info,get_area_ppl
        ...
        from application.tobacco_rules.rules import main
        print(f"{str(dt.now())}----------cluster")
        main()

        from application.tobacco_rules.rules import get_qty_vfr_except,get_same_vfr_grade_excpet,get_around_order_except,get_around_item_except,\
        ...
        from application.tobacco_rules.rules import get_order_stats_info,get_order_yoy_info,get_ratio
        ...
        from application.tobacco_rules.rules import get_cust_name,get_city_county,get_lng_lat,one_card_multi_cust,get_grade_except, \
