# -*- coding: utf-8 -*-
"""
Created on Thu Jun 20 18:18:49 2019
...
def train_pur_model(params,df,n,val,num_iter,sep_date='2019-04-01'):
    ...
    if val:
        ...
        num_iter = model_purchase.best_iteration_ + 10 # get best iteration
    ...
    if val:
        ...
        model_val.fit(train_X, train_y, eval_set=[(val_X, val_y)], eval_metric='mse',verbose=1,early_stopping_rounds=200,
                                                  categorical_feature=['item_id',
                                                                       ...
                                                                       'fut1_holiday_type',
                                                                       'his1_holiday_type'])
        num_iter = model_val.best_iteration_ + 50 # get best iteration
